...
import com.cvg.microserv2.services.ProductServiceImp;
...
public class ProductServiceMockTest {
    ...
    public void setup() {
        ...
        Product computer = Product.builder()
                .id(1L)
                .name("computer")
                .category(Category.builder().id(1L).name("asies").build() )
    ...
    public void whenValidUpdateStock_ThenReturnNewStock() {
        Product newProduct = productService.updateStock(1L, Double.parseDouble("8"));
        Assertions.assertThat(newProduct.getStock()).isEqualTo(13);
    }
